...
def params():
    ...
    inter_corner_shape = (20, 14) ## w, h
    size_per_grid = 0.05 ## meter

    # file_path = 'path to your file'
    file_path = '/home/jaejun/bagfile/0812/'
    img_type = "png"
    # camera_name_list = ['front', 'left', 'right']
    camera_name_list = ['24184897']
...
def image_process(camera_name, path, inter_corner_shape, size_per_grid, img_type, mode):
    ...
    # save_pio = img_dir.replace('raw','corer_finding')
